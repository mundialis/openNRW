...
############################################################################
#
# NAME:         01_grass_import_opennrw_dgm1_EPSG4647_gemeinden.sh
#
...
# debug
# zip=dgm1_05314000_Bonn_EPSG4647_XYZ.zip
...
for zip in $(ls dgm*_EPSG4647_XYZ.zip) ; do
    ...
    for dgm in $(ls dgm*.xyz) ; do
        ...
        # shift from EPSG:4647 to EPSG:25832, by adjusting false easting of coordinates
